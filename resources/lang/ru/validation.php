...
return [
    ...
    */
    ...
    'exists'               => 'Поле с таким :attribute не найдено.',
    'gt'                   => [
    ...
    'phone_number'         => 'Поле :attribute не является номером телефона',
    ...
    |
    */
    'phone' => 'Поле :attribute должно содержать номер телефона.',
    'wrongIP' => 'Доступ с IP адреса заблокирован',
    'id' => 'ID',
    'address' => [
        'id' => 'ID адреса',
    ],

    'badStatusToTransfer' => 'Нельзя изменить статус заказа. Тек. статус :currentStatus. Новый статус :newStatus',
    'orderAlreadyPacked' => 'Заказ уже собран',
